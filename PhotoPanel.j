...
- (id)init
{
    ...
    if (self)
    {
        ...
        images = [ [[CPImage alloc] initWithContentsOfFile:@"Resources/sample.png"
                                                      size:CGSizeMake(500.0, 430.0)], 
                    [[CPImage alloc] initWithContentsOfFile:@"Resources/sample2.png"
                                                       size:CGSizeMake(500.0, 389.0)],
                    [[CPImage alloc] initWithContentsOfFile:@"Resources/sample3.jpg"
                                                       size:CGSizeMake(413.0, 400.0)],
                    [[CPImage alloc] initWithContentsOfFile:@"Resources/sample4.png"
                                                       size:CGSizeMake(500.0, 375.0)],
                    [[CPImage alloc] initWithContentsOfFile:@"Resources/sample5.png"
                                                       size:CGSizeMake(500.0, 375.0)],
                    [[CPImage alloc] initWithContentsOfFile:@"Resources/sample6.png"
                                                       size:CGSizeMake(500.0, 375.0)] ];
